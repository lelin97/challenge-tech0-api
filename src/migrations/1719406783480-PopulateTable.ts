...
export class PopulateTable1719406783480 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`INSERT INTO boletos (id_boleto,descricao,data_vencimento,valor,valor_multa,juros,valor_total,dt_baixa,status_baixa,dt_cadastro,usuario_cadastro,dt_atualizacao,usuario_atualizacao) VALUES
